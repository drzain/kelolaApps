...
public class HospitalFarmasi extends Activity
{
    private Button btn_order,  btn_infus_dec, btn_syringe_dec, btn_nacl_dec;
    private LinearLayout btn_send;
    Dialog myDialog;
    private static final String TAG = HospitalFarmasi.class.getSimpleName();
                ...
                try {
                    ...
                    if (error.equals("1")) {
                        ...
                        btn_send.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v)
                            {
                                Intent i = new Intent(HospitalFarmasi.this, DashboardHospital.class);
                                startActivity(i);
                                finish();
                            }
                        });
